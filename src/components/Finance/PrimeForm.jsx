// src/components/Finance/PrimeForm.jsx
import React, { useState, useContext } from 'react';
import { AuthContext } from '../../context/AuthContext';
import { financeService } from '../../services/financeService';
import { teacherService } from '../../services/teacherService';

const PrimeForm = ({ onClose, onSave }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.libelle.trim()) newErrors.libelle = 'Libellé requis';
    ...
    <div style={styles.overlay}>
      <div style={styles.formContainer}>
        <div style={styles.header}>
          <h3 style={styles.title}>💵 Nouvelle Prime</h3>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.formGroup}>
            ...
            <input
              ...
              style={{
                ...styles.input,
                ...(errors.libelle && styles.inputError)
              }}
            />
            {errors.libelle && <span style={styles.errorText}>{errors.libelle}</span>}
          </div>
